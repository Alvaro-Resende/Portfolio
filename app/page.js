...
export default function Home() {
  return (
    <div className="w-full h-full bg-[#121212] flex flex-col justify-center items-center">

        <div className="relative w-full h-[650px] flex flex-col items-center justify-between">
          
          <Image src="/imagens/ia.png" alt="Tela de Fundo" fill className="z-0 opacity-40"/>
          
          <div className="w-full h-[50px] bg-black/75 backdrop-blur-none flex justify-end items-center space-x-5 p-2 z-50">
            <button className="bg-transparente transform transition hover:scale-110">Ínicio</button>
            <button className="bg-transparente transform transition hover:scale-110">Sobre</button>
            <button className="bg-transparente transform transition hover:scale-110">Habilidades</button>
            <button className="bg-transparente transform transition hover:scale-110">Projetos</button>
            <button className="bg-transparente transform transition hover:scale-110">Contatos</button>
          </div>
        ...
        <div className="w-[1100px] h-[450px] flex flex-col justify-center items-center space-y-8 ">
            ...
            <Image src="/imagens/alvaro.png" alt="Tela de Fundo" width="250" height="250" className="rounded-full"/> 
              ...
              <span className="w-[600px] text-justify text-xl">Possuo uma sólida formação em hardware e tecnologia da informação,
        ...
        <div className="w-[1100px] h-[550px] flex flex-col justify-center items-center gap-5">
        ...
        <div className="w-[1100px] flex flex-col justify-center items-center gap-8">

          <h1 className="text-3xl font-bold drop-shadow-[2px_2px_0px_rgba(0,0,0,1)] border-b-2">Projetos</h1>
          
          <div className="w-[1000px] h-[250px] flex justify-start items-center">
            ...
            <div className="flex flex-col gap-3 items-start justify-center w-[500px] h-[250px] p-8">
              <span className="text-2xl font-semibold drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]">Site Clone Senac MG</span>
              <spa className="w-[450px] h-[200px] ">Replica fiel da interface do site oficial do Senac MG, desenvolvida sem back-end.
                    Utilizei Next.js e Tailwind CSS para recriar o design responsivo e otimizado, garantindo fidelidade visual e usabilidade.</spa>
            </div>
          </div>

          <div className="w-[1000px] h-[250px] flex justify-start items-center">
            
            <div className="flex flex-col gap-3 items-end justify-center w-[500px] h-[250px] p-8">
              <span className="text-2xl font-semibold drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]">Landing Page para Oficina</span>
              <spa className="w-[450px] h-[200px] text-end">Desenvolvi uma landing page moderna para uma oficina mecânica, focada em responsividade e design intuitivo.
          ...
          <div className="w-[1000px] h-[250px] flex justify-start items-center">
            ...
            <div className="flex flex-col gap-3 items-start justify-center w-[500px] h-[250px] p-8">
              ...
              <spa className="w-[450px] h-[200px] ">Criei um site estático para exibir informações sobre o clima, com um layout moderno e totalmente responsivo. 
        ...
        <div className="w-[1100px] h-[550px] flex flex-col justify-center items-center gap-8">

          <h1 className="text-3xl font-bold drop-shadow-[2px_2px_0px_rgba(0,0,0,1)] border-b-2">Entre em Contato</h1>

          <div className="flex flex-col gap-3">

            <input className=" rounded-lg w-[600px] h-[55px] bg-[#202020] text-[#8F8F8F] outline-none p-3" placeholder="Seu Nome" ></input>

            <input className=" rounded-lg w-[600px] h-[55px] bg-[#202020] text-[#8F8F8F] outline-none p-3" placeholder="Seu E-mail" ></input>

            <textarea className=" rounded-lg w-[600px] h-[110px] bg-[#202020] text-[#8F8F8F] outline-none p-3 text-start items-star pt-2" placeholder="Seu Nome" ></textarea>
          </div>

          <button className="w-[600px] h-[55px] bg-black text-white rounded-lg text-2xl font-semibold hover:bg-[#8F8F8F] transform transition hover:scale-110">Enviar</button>
